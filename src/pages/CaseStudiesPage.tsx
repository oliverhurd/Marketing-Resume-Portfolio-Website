    ...
    <main className="max-w-5xl mx-auto px-6 py-24 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
        ...
        <div 
          ...
          className="border border-gray-divider rounded-xl p-8 md:p-10 hover:shadow-md transition-shadow bg-white relative overflow-hidden flex flex-col h-full cursor-pointer group"
        >
          ...
          <h3 className="text-3xl font-serif font-bold text-navy-dark mb-4 group-hover:text-navy-blue transition-colors">
            Braveheart Trading
          </h3>
        ...
        {/* Card 2 */}
        <div className="border border-gray-divider rounded-xl p-8 md:p-10 hover:shadow-md transition-shadow bg-white relative overflow-hidden flex flex-col h-full cursor-pointer group">
      ...
      <div className="max-w-2xl mx-auto">
        <div className="border border-gray-divider rounded-xl p-8 md:p-10 hover:shadow-md transition-shadow bg-white relative overflow-hidden flex flex-col cursor-pointer group">
